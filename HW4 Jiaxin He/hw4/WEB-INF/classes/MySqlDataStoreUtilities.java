...
public class MySqlDataStoreUtilities {
 ...
 //deleteOrder
  ...
  //insertOrder
    ...
    public static String selectProductId(String Product_Name) {
    	String ID = "";
        try {

            getConnection();
            //select the table
            PreparedStatement pst = conn.prepareStatement("select Id from Productdetails where ProductName=?");
...
// insertUse
    ...
    public static boolean insertNewProducts(String ProductType,String id, String productName, double productPrice, String productImage,String productManufacturer,String productCondition, String productDiscount) {
        try {

            getConnection();
            String insertIntoCustomerAddressQuery = "INSERT INTO Productdetails(ProductType,id,productName,productPrice,productImage,productManufacturer,productCondition,productDiscount,inventory,rebates) "
                    + "VALUES (?,?,?,?,?,?,?,?,?,?);";
    ...
    public static void insertProducts() {
        try {
            ...
            getConnection();
            String insertProductQuery = "INSERT INTO  Productdetails(ProductType,Id,productName,productPrice,productImage,productManufacturer,productCondition,productDiscount,inventory,rebates)" +
                    "VALUES (?,?,?,?,?,?,?,?,?,?);";
    ...
    public static void insertTransactions(String loginId, String Customer_Name, int Customer_Age,  
    		String Customer_Occupation, String Credit_Card_Number, int Order_ID, String Order_Date,String Expected_Delivery_Date,
    		String Actual_Delivery_Date,String Product_ID,String Product_Name,String Category,String Manufacturer,int Review_Rating,String Delivery_Tracking_ID,String Delivery_Type,
    		String Delivery_Zip_Code,String Transaction_Status,String Order_Returned,String Order_Delivered_on_Time) {
        try {

            getConnection();

            String insertIntoCustomerOrderQuery = "insert into transactions (loginId, Customer_Name, Customer_Age, Customer_Occupation, "
            		+ "Credit_Card_Number,Order_ID,Order_Date, Expected_Delivery_Date,Actual_Delivery_Date,Product_ID,Product_Name,Category, Manufacturer,Review_Rating,Delivery_Tracking_ID,Delivery_Type"
            		+ ",Delivery_Zip_Code,Transaction_Status,Order_Returned,Order_Delivered_on_Time) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
