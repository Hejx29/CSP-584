...
public class SoundSystemsList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
		  if(CategoryName.equals("beFreeSound"))
		  {
			for(Map.Entry<String,SoundSystem> entry : SaxParserDataStore.soundsystems.entrySet())
				{
				if(entry.getValue().getRetailer().equals("beFree Sound"))
				 {
		  ...
		  else if(CategoryName.equals("gpx"))
		  {
			for(Map.Entry<String,SoundSystem> entry : SaxParserDataStore.soundsystems.entrySet())
				{
				if(entry.getValue().getRetailer().equals("GPX"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
		  ...
		  else if(CategoryName.equals("poppinpod"))
		  {
			for(Map.Entry<String,SoundSystem> entry : SaxParserDataStore.soundsystems.entrySet())
				{
				if(entry.getValue().getRetailer().equals("PoppinPodKolo"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}
