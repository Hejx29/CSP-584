...
public class Payment extends HttpServlet {
		...
		cal2.add(Calendar.DAY_OF_MONTH, randNumber);
				...
				if(optionvalue.equals("homedelivery")) {
					//int count1 = countnumber.get(oi.getName());
				       // String count = String.valueOf(count1);
						...
						utility.storetransactions(orderId,fullName,zipCode,creditCardNo,deliverydate3,deliverydate,optionvalue,oi.getName(),deliverydate2);
				}else {
