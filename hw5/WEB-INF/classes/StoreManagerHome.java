...
//        
            ...
            pw.print("<td>" + tv.getName() + "</td>" +
                    ...
                    "<td>TV </td>"+"<td><div align=\"left\" style=\"float:left\"><input type='submit' name='Product' value='Update' class='btnbuy'></div></td>"
                    +"<td><div align=\\\"right\\\"><input type='submit' name='Product' value='Remove' class='btnbuy'></div></td>" );
        ...
        for (Map.Entry<String, SoundSystem> entry : SaxParserDataStore.soundsystems.entrySet()) {
            ...
            pw.print("<td>" + soundsystem.getName() + "</td>" +
                    ...
                    "<td>Soundsystem</td>"+
                    "<td><div align=\"left\" style=\"float:left\"><input type='submit' name='Product' value='Update' class='btnbuy'></div></td>"
                    +"<td><div align=\\\"right\\\"><input type='submit' name='Product' value='Remove' class='btnbuy'></div></td>" );
