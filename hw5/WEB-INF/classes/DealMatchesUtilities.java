...
public class DealMatchesUtilities extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            pw.print("<img src='images/site/bg01.png' style=\"width: 500px; display: block; margin-left: auto; margin-right: auto\" />");
            pw.print("<br> <br>");
            pw.print("<h2 style =\"color:#000000;margin:center;text-align:center;font size=\" >Online shopping from a great selection at BEST DEAL</h2>");
            ...
            for (Map.Entry<String, Product> entry : productmap.entrySet()) {
                ...
                if (selectedproducts.size() < 2 && !selectedproducts.containsKey(entry.getKey())) {
                    ...
                    if (line == null) {
                        pw.print("<h3 style =\"color:#0678c6;margin:center;text-align:center;font size=15px\"'>No Offers Found</h3>");
                        break;
                    } else {
                        do {
                            ...
                            if (line.contains(entry.getKey())) {
                                ...
                                pw.print("<h3 style =\"color:#0678c6;margin:center;text-align:center;font size=15px\">" + line + "</h3>");
                                pw.print("<br>");
            ...
            pw.print("<h2 style =\"color:#0678c6;margin:center;text-align:center;font size=15px\"'>No Offers Found</h2>");
        }
        pw.print("</div>");
        pw.print("</div>");
        pw.print("<div class='post'>");
        ...
        if (selectedproducts.size() == 0) {
            pw.print("<h2 style =\"color:#0678c6;margin:center;text-align:center;font size=15px\"'>No Deals Found</h2>");
        } else {
            ...
            for (Map.Entry<String, Product> entry : selectedproducts.entrySet()) {
                ...
                pw.print("<li><form method='post' action='Cart'>" +
    					...
    					"<input type='hidden' name='type' value='" + entry.getValue().getType().toLowerCase() + "'>"+
