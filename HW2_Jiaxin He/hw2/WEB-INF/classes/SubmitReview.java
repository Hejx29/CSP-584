...
public class SubmitReview extends HttpServlet {
    ...
    protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String message = utility.storeReview(productName, productType, productMaker, reviewRating, reviewDate, reviewText, retailerPin, productPrice, retailerCity, userAge,userAddress, userGender, userOccupation);
