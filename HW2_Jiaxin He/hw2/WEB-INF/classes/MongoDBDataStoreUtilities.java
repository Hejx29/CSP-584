...
public class MongoDBDataStoreUtilities {
    ...
    public static String insertReview(String productname, String username, String producttype, String productmaker,
                                      ...
                                      String price, String retailercity, String userAge,String Address, String userGender, String userOccupation) {
        try {
            getConnection();
        ...
        try {
            ...
            while (cursor.hasNext()) {
                ...
                Review review = new Review(obj.getString("productName"), obj.getString("userName"), obj.getString("productType"),
                        ...
                        obj.getString("retailerpin"), obj.getString("price"), obj.getString("retailercity"), obj.getString("userAge"), obj.getString("userAddress"),obj.getString("userGender"), obj.getString("userOccupation"));
