...
//    }
    ...
    protected void displayInventory(HttpServletRequest request,
        ...
        pw.print("<a style='font-size: 24px;'>Table of Product Inventory</a>");
        ...
        pw.println("        'width':1500,");
        pw.println("       'height':2100};");
        ...
        pw.print("<div class='post'>");
        pw.print("<h2 class='title meta'>");
        pw.print("<a style='font-size: 24px;'>Bar Chart of Inventory</a>");
        pw.print("</h2><div class='entry'>");
        ...
        pw.print("<div class='post'>");
        pw.print("<h2 class='title meta'>");
        pw.print("<a style='font-size: 24px;'>Table of all products currently on sale</a>");
        pw.print("</h2><div class='entry'>");
        ...
        pw.print("<div class='post'>");
        pw.print("<h2 class='title meta'>");
        pw.print("<a style='font-size: 24px;'>Table of all products currently that have manufacturer rebates</a>");
        pw.print("</h2><div class='entry'>");
        ...
        for (Product product : productMap.values()) {
            ...
            pw.print("<tr>");
            pw.print("<td>" + product.getName() + "</td>");
            pw.print("<td>" + product.getrebate() + "</td>");
            pw.print("</tr>");
