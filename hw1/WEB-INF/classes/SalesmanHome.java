...
public class SalesmanHome extends HttpServlet {
        ...
        if (request.getParameter("customer") != null && request.getParameter("customer").equals("Create Customer")) {
            ...
            if (!hm.containsKey(customerName)) {
                ...
                if (utility.isItemExist(itemCatalog, itemName)) {
                    ...
                    utility.storeNewOrder(orderId, itemName, customerName, totalPrice, fullName,streetAddress,zipCode, creditCardNo);
    ...
    protected void displaySalesmanHome(HttpServletRequest request,
        ...
        pw.print("</td></tr><tr><td>");
        pw.print("<h4>Address( street, city, state)</h3></td><td><input type='text' name='streetAddress' value='' class='input' required></input>");
        pw.print("</td></tr><tr><td>");
...
//                        "<td>" + od.getZipCode() + "</td>" +
                ...
                pw.print("<input type='hidden' name='address' value='" + od.getStreetAddress() + "'>");
