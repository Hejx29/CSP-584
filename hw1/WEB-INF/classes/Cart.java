...
//        pw.print("<form name ='CartForm' action='RemoveCart' method='post'>");
        if (utility.CartCount() > 0) {
            ...
            for (OrderItem oi : utility.getCustomerOrders()) {
                ...
                //pw.print("<td><input type=\"button\" name=\"button\" value=\"Remove\" onclick=\"removeCart(\'"+ oi.getName() +"\')\"></td>");
                //pw.print("<td><a href=\"javascript:void(0);\" onclick=\"removeCart(\'"+oi.getName() +"\')\" class=\"Remove\">Remove</a></td>");
                pw.print("<input type='hidden' name='orderName' value='" + oi.getName() + "'>");
                //pw.print("<input type='hidden' name='itemType' value='" +  +oi.get "'>");
