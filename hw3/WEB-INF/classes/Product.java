...
public class Product {
    ...
    public Product(String id, String name, double price, String image, String retailer, String condition, String type, double discount,double rebate) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.image = image;
    ...
    public Product(String name, double price, double rebate) {
        this.name = name;
        this.price = price;
        this.rebate = rebate;
    }
