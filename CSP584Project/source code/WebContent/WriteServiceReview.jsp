...
<%
    ...
    int serviceNo = Integer.parseInt(request.getParameter("orderId"));
            ...
            <form name='WriteReview' action='WriteReview' method='post'>
                <table border="1px" width="460px" height="100px" style="margin: auto">
                    ...
                    <tr>
                        ...
                        <td>
                            <%=oi.getServiceName() %>
                            <input type='hidden' name='productName' value='<%=oi.getServiceName() %>'>
                        </td>
                    </tr>


                    <tr>
                        <td> Total Service Hour:</td>
                        <td>
                            <%=oi.getHour() %>
                            <input type='hidden' name='hour' value='<%=oi.getHour() %>'>
                        </td>
                    </tr>
