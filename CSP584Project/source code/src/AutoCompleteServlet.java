    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("lookup")) {
                ...
                HashMap<Integer, Product> data = AjaxUtility.getData();
                if ((searchId != null) && data.containsKey(Integer.parseInt(searchId.trim()))) {
                    request.setAttribute("data", data.get(Integer.parseInt(searchId.trim())));
